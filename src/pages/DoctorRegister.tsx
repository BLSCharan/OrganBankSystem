...
export default function DoctorRegister() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const BASE_URL = "https://backend-ihst.onrender.com"; // 🔥 Added backend Render link here
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8">
        <h2 className="text-3xl font-bold text-center text-gray-800 mb-8">Doctor Registration</h2>
        ...
        <p className="mt-4 text-center text-gray-600">
          ...
          <Link to="/doctor/login" className="text-blue-500 hover:text-blue-600">
            Login here
          </Link>
        </p>
      </div>
